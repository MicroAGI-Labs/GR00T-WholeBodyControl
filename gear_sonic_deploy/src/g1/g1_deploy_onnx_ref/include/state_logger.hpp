 ...
 *   left_hand_q/dq.csv  | Left RH56E2 policy-space positions / velocities
 *   right_hand_q/dq.csv | Right RH56E2 policy-space positions / velocities
...
class StateLogger {
 public:
  struct Entry {
    ...
    // RH56E2 policy channels (six actuators plus one unused checkpoint slot)
