...
from gear_sonic.envs.manager_env.robots import g1, h2, tiangong2dex
...
class ModularTrackingEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def override_settings(self):
        ...
        robot_mapping = {
            ...
            "tiangong2dex": {
                "robot_cfg": tiangong2dex.TIANGONG2DEX_CFG,
                "action_scale": tiangong2dex.TIANGONG2DEX_ACTION_SCALE,
                "isaaclab_to_mujoco_mapping": tiangong2dex.TIANGONG2DEX_ISAACLAB_TO_MUJOCO_MAPPING,
            },
        }
